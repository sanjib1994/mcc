package com.salk.mycircadianclock.camera2;
...
public class BaseCamera extends Fragment
    ...
    public static BaseCamera newInstance() {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        file = new CommonUsedmethods().create_directory();

        sharedPreferences = new TinylocalDb().get_shared_pref(BaseActivity.baseActivity);
    ...
    private void requestCameraPermission() {
        if (shouldShowRequestPermissionRationale(Manifest.permission.CAMERA)) {
            ...
            requestPermissions(new String[]{Manifest.permission.CAMERA,Manifest.permission.READ_EXTERNAL_STORAGE,
                    Manifest.permission.WRITE_APN_SETTINGS}, REQUEST_CAMERA_PERMISSION);
        }
    }
    ...
    /**
     * Opens the camera specified by {@link BaseCamera#mCameraId}.
     */
    private void openCamera(int width, int height) {

        if (ActivityCompat.checkSelfPermission(BaseActivity.baseActivity, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED &&
                ActivityCompat.checkSelfPermission(BaseActivity.baseActivity, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED
                && ActivityCompat.checkSelfPermission(BaseActivity.baseActivity, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
                    ...
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            try {
                                ...
                                makeJsonCamera(mPreviewRequestBuilder);
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    new CompressImage(BaseActivity.baseActivity,Uri.fromFile(mFile),mFile.getAbsolutePath(), new OnCompressComplted(){
